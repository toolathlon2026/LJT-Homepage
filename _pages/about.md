...
I am a first-year PhD candidate at [HKUST NLP Group](https://nlp.ust.hk/) under the supervision of [Professor Junxian He](https://junxianhe.github.io/). My research focuses on **natural language processing** and **machine learning**, with specific interests including:
...
1. **Junteng Liu**, Yuanxiang Fan, Zhuo Jiang, Han Ding, Yongyi Hu, Chi Zhang, Yiqi Shi, Shitong Weng, Aili Chen, Shiqi Chen, Yunan Huang, Mozhi Zhang, Pengyu Zhao, Junjie Yan, Junxian He. "**SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond**." *Arxiv*, 2025. [[Project]](https://github.com/Vicent0205/SynLogic)

2. **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. "**On the Perception Bottleneck of VLMs for Chart Understanding**." *Arxiv*, 2025. [[Project]](https://github.com/Vicent0205/Vision4Chart)

3. **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. "**On the Universal Truthfulness Hyperplane Inside LLMs**." *EMNLP 2024*. [[Project]](https://github.com/Vicent0205/Universal_Truthfulness_Hyperplane)
